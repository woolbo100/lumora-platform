...
export function EgenVsTetoResultPanel({ result }: EgenVsTetoResultPanelProps) {
  ...
  return (
    <div className="grid gap-6 lg:grid-cols-[1.08fr_0.92fr]">
      <GlassPanel className="aurora-hover-surface aurora-hover border-[var(--color-secondary)]/18 bg-[linear-gradient(180deg,rgba(255,255,255,0.11),rgba(10,13,28,0.34))] p-8 sm:p-10">
        ...
        <div className="mt-8 grid gap-4 md:grid-cols-2">
          <div className="aurora-hover rounded-[24px] border border-white/10 bg-white/6 p-5">
        ...
        <div className="aurora-hover mt-8 rounded-[26px] border border-[var(--color-secondary)]/24 bg-[linear-gradient(135deg,rgba(213,195,165,0.14),rgba(122,104,217,0.08)_55%,rgba(255,255,255,0.04))] p-6 shadow-[0_20px_60px_rgba(66,55,128,0.18)]">
      ...
      <div className="grid gap-6">
        <GlassPanel className="aurora-hover-surface aurora-hover p-8">
          <p className="text-sm uppercase tracking-[0.3em] text-white/50">Strengths</p>
          <div className="mt-6 grid gap-4">
            {result.strengths.map((strength) => (
              <div
                key={strength}
                className="aurora-hover rounded-[22px] border border-white/10 bg-white/6 p-5"
              >
                <p className="leading-7 text-[var(--foreground-soft)]">• {strength}</p>
              </div>
            ))}
            <div className="aurora-hover rounded-[22px] border border-white/10 bg-white/6 p-5">
        ...
        <GlassPanel className="aurora-hover-surface aurora-hover p-8">
          ...
          <div className="aurora-hover mt-6 rounded-[22px] border border-white/10 bg-white/6 p-5">
