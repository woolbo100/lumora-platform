  ...
  return (
    <main className="flex flex-1 flex-col gap-8 pb-8">
      <div className="text-center">
        ...
        <p className="mx-auto mt-5 max-w-3xl text-base leading-8 text-white/72 sm:text-lg">
      ...
      <div className="flex flex-wrap gap-4">
        <Link
          ...
          className="inline-flex min-h-12 items-center justify-center rounded-full border border-white/15 bg-white/6 px-6 py-3 text-sm font-semibold tracking-[0.18em] text-white/82 transition duration-300 hover:-translate-y-0.5 hover:border-white/25"
        >
          카드 다시 고르기
        </Link>
        <Link
          href="/tarot"
          className="inline-flex min-h-12 items-center justify-center rounded-full bg-[var(--color-primary)] px-6 py-3 text-sm font-semibold tracking-[0.18em] text-white transition duration-300 hover:-translate-y-0.5 hover:bg-[#7f71dc]"
        >
          다른 주제로 다시 보기
        </Link>
      </div>
