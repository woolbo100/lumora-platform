      ...
      <GlassPanel className="border-[var(--color-secondary)]/18 bg-[linear-gradient(180deg,rgba(255,255,255,0.11),rgba(10,13,28,0.34))] p-8 sm:p-10">
        ...
        <div className="mt-10 grid gap-4">
          <div className="rounded-[24px] border border-white/10 bg-black/10 p-5">
            ...
            <p className="mt-3 leading-7 text-white/80">{result.relationshipPattern}</p>
          </div>
          <div className="rounded-[24px] border border-white/10 bg-black/10 p-5">
            <p className="text-xs uppercase tracking-[0.25em] text-white/45">
              감정 습관
            </p>
            <p className="mt-3 leading-7 text-white/80">{result.emotionalHabit}</p>
          </div>
          <div className="rounded-[24px] border border-white/10 bg-black/10 p-5">
            <p className="text-xs uppercase tracking-[0.25em] text-white/45">
              두려움 포인트
            </p>
            <p className="mt-3 leading-7 text-white/80">{result.fearPoint}</p>
          </div>
          <div className="rounded-[24px] border border-white/10 bg-black/10 p-5">
            <p className="text-xs uppercase tracking-[0.25em] text-white/45">
              회복 가이드
            </p>
            <p className="mt-3 leading-7 text-white/80">{result.healingGuide}</p>
          </div>
        </div>
      ...
      <GlassPanel className="p-8">
        ...
        <div className="mt-6 grid gap-4">
          ...
          <div className="rounded-[22px] border border-white/10 bg-white/6 p-5">
            ...
            <p className="mt-3 leading-7 text-white/76">{result.recommendedMessage}</p>
          </div>
          <div className="rounded-[22px] border border-white/10 bg-white/6 p-5">
